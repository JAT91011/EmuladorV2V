namespace EmuladorV2I
{
    partial class frmAsistenteConfiguracion
    {
        ...
        private void InitializeComponent()
        {
            ...
            resources.ApplyResources(this.panComunicacion, "panComunicacion");
            ...
            resources.ApplyResources(this.btnRefrescarPuertosSerie, "btnRefrescarPuertosSerie");
            ...
            resources.ApplyResources(this.pbBluetooth, "pbBluetooth");
            ...
            resources.ApplyResources(this.cboVelocidadTransmision, "cboVelocidadTransmision");
            this.cboVelocidadTransmision.FormattingEnabled = true;
            this.cboVelocidadTransmision.Items.AddRange(new object[] {
            resources.GetString("cboVelocidadTransmision.Items"),
            resources.GetString("cboVelocidadTransmision.Items1"),
            resources.GetString("cboVelocidadTransmision.Items2"),
            resources.GetString("cboVelocidadTransmision.Items3"),
            resources.GetString("cboVelocidadTransmision.Items4"),
            resources.GetString("cboVelocidadTransmision.Items5"),
            resources.GetString("cboVelocidadTransmision.Items6"),
            resources.GetString("cboVelocidadTransmision.Items7"),
            resources.GetString("cboVelocidadTransmision.Items8"),
            resources.GetString("cboVelocidadTransmision.Items9"),
            resources.GetString("cboVelocidadTransmision.Items10")});
            ...
            resources.ApplyResources(this.cboPuertoSerie, "cboPuertoSerie");
            this.cboPuertoSerie.FormattingEnabled = true;
            this.cboPuertoSerie.Name = "cboPuertoSerie";
            // 
            // lblVelocidadTransmision
            // 
            resources.ApplyResources(this.lblVelocidadTransmision, "lblVelocidadTransmision");
            ...
            // lblPuertoSerie
            // 
            resources.ApplyResources(this.lblPuertoSerie, "lblPuertoSerie");
            ...
            resources.ApplyResources(this.panCircuito, "panCircuito");
            ...
            resources.ApplyResources(this.ibCamara, "ibCamara");
            ...
            resources.ApplyResources(this.panCabecera, "panCabecera");
            ...
            resources.ApplyResources(this.panBotonera, "panBotonera");
